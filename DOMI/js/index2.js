...
var anoAtual = kalendae.getFullYear();
var exec = document.getElementById("modf");
var dataNacimento = document.querySelector('input#nascData');
var femi = document.getElementById("F");
var masc = document.getElementById("M");
var imagem = document.createElement('img');
var texto = document.createElement("p");
var conteudoResp = document.querySelector("div#Resposta");
function idade() {
    ...
    if (Number(dataNacimento.value) > anoAtual) {
        window.alert("O ano ".concat(dataNacimento, " \u00E9 inv\u00E1lido para uma data de nascimento"));
    }
    else {
        var Idade = anoAtual - Number(dataNacimento.value);
        console.log("".concat(Idade));
