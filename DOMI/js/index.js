//aplicação interativa 01

let kalendae = new Date();
let anoAtual = kalendae.getFullYear();

const exec = document.getElementById("modf");

let dataNacimento = document.querySelector('input#nascData');

let femi = document.getElementById("F");
let masc = document.getElementById("M");

//elemento.innerText

//elemento.appendChild() e removeChild()
//elemento.setAttribute('atributoHtml', 'valor')

let imagem = document.createElement('img');
let texto = document.createElement("p");
let conteudoResp = document.querySelector("div#Resposta");
